...
def recibir():
    ...
    image_result = open('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\'+orden[0], 'ab')#Cambiar con respecto al usuario,escritura y binario
    image_result.write(image_64_decode)
    size_file = os.path.getsize('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\'+orden[0])
...
if orden=='upload':
    direccion='C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\'+nombreArchivo
