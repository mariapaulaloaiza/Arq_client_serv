...
def enviar(orden,nombreArchivo,key,value):
    f = open('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\'+'servidor1'+'\\'+key, 'rb')# R lee el archivo en modo binario B
    print('enviando...')
...
def recibir(orden):
    ...
    image_result = open('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\servidor1\\'+orden[2], 'ab')#Cambiar con respecto al usuario,escritura y binario
    image_result.write(image_64_decode)
    size_file = os.path.getsize('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\servidor1\\'+orden[2])
...
while True:
    ...
    if orden[0]=='sharelink':
        mensaje='C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega'+orden[1]+'.json'
        s.send_multipart([mensaje.encode()])
    if orden[0]=='list':
        list = os.listdir("C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\servidor1") # dir is your directory path
