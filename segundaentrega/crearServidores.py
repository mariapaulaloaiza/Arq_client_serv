...
def crearServidores():
    servidores=[]
    if os.stat('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\servidores.txt').st_size == 0:
        #Se crean 3 servidores
        for i in range(3):
            nombreServidor=randomName()
            datosServidores = open('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\servidores.txt', 'a')
            datosServidores.write(str(nombreServidor)+'\n')
            servidores.append(nombreServidor)
        return servidores
    else:
        nombresServidores = open('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\segundaentrega\\servidores.txt', "r")
        while(True):
