...
if orden=='upload':
    direccion='C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\semana5\\'+nombreArchivo
    llave=shasum('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\semana5\\'+nombreArchivo)
    ...
    if orden=='downloadlink':
        try:
            ...
            recibir('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\semana5\\servidor\\'+username+'\\',link)
        except:
    ...
    if orden=='download':
        try:
            ...
            mensaje=' '
            s.send_multipart([username.encode(),orden.encode(),nombreArchivo.encode(),mensaje.encode()])
            recibir('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\semana5\\',nombreArchivo)
        except:
            print('no se ha cargado el archivo')
    if orden=='list':
        mensaje=' '
