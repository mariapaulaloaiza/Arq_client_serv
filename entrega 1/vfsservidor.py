...
def recibir(orden):
    #tamanoArchivo=os.path.getsize('C:\\Users\\Sofia\\Documents\\utp\\arquitectura\\semana5\\'+orden[2])
    while True:
        print("recibiendo...")
        ...
        if image_64_decode==b'0':
            ...
            image_result = open('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\semana5\\servidor\\'+orden[0]+'\\'+orden[2], 'ab')#Cambiar con respecto al usuario,escritura y binario
            image_result.write(image_64_decode)
            size_file = os.path.getsize('C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\semana5\\servidor\\'+orden[0]+'\\'+orden[2])
...
while True:
    ...
    if orden[1]=='download' or orden[1]=='downloadlink':
        enviar(orden[0],orden[1],orden[2],'C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\semana5\\servidor\\'+orden[0]+'\\'+orden[2])
    if orden[1]=='sharelink':
        mensaje='C:\\Users\\Usuario\\Documents\\utp\\arquitectura\\semana5\\servidor\\'+orden[0]+'\\'+orden[2]
        s.send_multipart([mensaje.encode()])
    if orden[1]=='list':
